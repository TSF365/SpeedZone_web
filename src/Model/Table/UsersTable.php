    ...
    public function initialize(array $config): void
{
    ...
    // Defining the hasMany relationship with estatisticasjogador
    $this->hasMany('Estatisticasjogador', [
    ...
    public function validationDefault(Validator $validator): Validator
    {
        ...
        $validator
            ...
            ->maxLength('nacionalidade', 35)
            ->allowEmptyString('nacionalidade');

        $validator
            ->dateTime('dataRegisto')
            ->allowEmptyDateTime('dataRegisto');
