...
<div class="row">
    <aside class="column">
        <div class="side-nav">
            ...
            <?= $this->Form->postLink(
                __('Delete'),
                ['action' => 'delete', $estatisticasjogador->idEstatistica],
                ['confirm' => __('Are you sure you want to delete # {0}?', $estatisticasjogador->idEstatistica), 'class' => 'side-nav-item']
            ) ?>
    ...
    <div class="column column-80">
        <div class="estatisticasjogador form content">
            ...
            <fieldset>
                <legend><?= __('Edit Estatisticasjogador') ?></legend>
                <?php
