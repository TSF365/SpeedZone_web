...
<div class="row">
    <aside class="column">
        <div class="side-nav">
            ...
            <?= $this->Form->postLink(
                __('Delete'),
                ['action' => 'delete', $historicocorrida->idCorrida],
                ['confirm' => __('Are you sure you want to delete # {0}?', $historicocorrida->idCorrida), 'class' => 'side-nav-item']
            ) ?>
    ...
    <div class="column column-80">
        <div class="historicocorridas form content">
            ...
            <fieldset>
                <legend><?= __('Edit Historicocorrida') ?></legend>
                <?php
